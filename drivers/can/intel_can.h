...
/* Time Triggered registers */
/* TTTMC */
#define CAN_TTTMC_TMSA_POS 0
#define CAN_TTTMC_TMSA_MASK (0x3fffu << CAN_TTTMC_TMSA_POS)
#define CAN_TTTMC_TMSA(value)                                                  \
	((CAN_TTTMC_TMSA_MASK & ((value) << CAN_TTTMC_TMSA_POS)))
#define CAN_TTTMC_TME_POS 16
#define CAN_TTTMC_TME_MASK (0x3fffu << CAN_TTTMC_TME_POS)
#define CAN_TTTMC_TME(value)                                                   \
	((CAN_TTTMC_TME_MASK & ((value) << CAN_TTTMC_TME_POS)))

/* TTRMC */
#define CAN_TTRMC_RID_POS 0
#define CAN_TTRMC_RID_MASK (0x1fffffffu << CAN_TTRMC_RID_POS)
#define CAN_TTRMC_RID(value)                                                   \
	((CAN_TTRMC_RID_MASK & ((value) << CAN_TTRMC_RID_POS)))
#define CAN_TTRMC_XTD (0x1u << 30)
#define CAN_TTRMC_STD (0x0u << 30)
#define CAN_TTRMC_RMPS (0x1u << 31)

/* TTOCF */
#define CAN_TTOCF_OM_POS 0
#define CAN_TTOCF_OM_MASK (0x3u << CAN_TTOCF_OM_POS)
#define CAN_TTOCF_OM(value)                                                    \
	((CAN_TTOCF_OM_MASK & ((value) << CAN_TTOCF_OM_POS)))
#define CAN_TTOCF_OM_DEFAULT (0x0u << 0)
#define CAN_TTOCF_OM_TTCAN_LEVEL1 (0x1u << 0)
#define CAN_TTOCF_OM_TTCAN_LEVEL2 (0x2u << 0)
#define CAN_TTOCF_OM_TTCAN_LEVEL0 (0x3u << 0)
#define CAN_TTOCF_GEN (0x1u << 3)
#define CAN_TTOCF_TM (0x1u << 4)
#define CAN_TTOCF_LDSDL_POS 5
#define CAN_TTOCF_LDSDL_MASK (0x7u << CAN_TTOCF_LDSDL_POS)
#define CAN_TTOCF_LDSDL(value)                                                 \
	((CAN_TTOCF_LDSDL_MASK & ((value) << CAN_TTOCF_LDSDL_POS)))
#define CAN_TTOCF_IRTO_POS 8
#define CAN_TTOCF_IRTO_MASK (0x7fu << CAN_TTOCF_IRTO_POS)
#define CAN_TTOCF_IRTO(value)                                                  \
	((CAN_TTOCF_IRTO_MASK & ((value) << CAN_TTOCF_IRTO_POS)))
#define CAN_TTOCF_EECS (0x1u << 15)
#define CAN_TTOCF_AWL_POS 16
#define CAN_TTOCF_AWL_MASK (0xffu << CAN_TTOCF_AWL_POS)
#define CAN_TTOCF_AWL(value)                                                   \
	((CAN_TTOCF_AWL_MASK & ((value) << CAN_TTOCF_AWL_POS)))
#define CAN_TTOCF_EGTF (0x1u << 24)
#define CAN_TTOCF_ECC (0x1u << 25)
#define CAN_TTOCF_EVTP (0x1u << 26)

/* TTMLM */
#define CAN_TTMLM_CCM_POS 0
#define CAN_TTMLM_CCM_MASK (0x3fu << CAN_TTMLM_CCM_POS)
#define CAN_TTMLM_CCM(value)                                                   \
	((CAN_TTMLM_CCM_MASK & ((value) << CAN_TTMLM_CCM_POS)))
#define CAN_TTMLM_CCM_1_CYCLE (0x0u << 0)
#define CAN_TTMLM_CCM_2_CYCLE (0x1u << 0)
#define CAN_TTMLM_CCM_4_CYCLE (0x3u << 0)
#define CAN_TTMLM_CCM_8_CYCLE (0x7u << 0)
#define CAN_TTMLM_CCM_16_CYCLE (0xfu << 0)
#define CAN_TTMLM_CCM_32_CYCLE (0x1fu << 0)
#define CAN_TTMLM_CCM_64_CYCLE (0x3fu << 0)
#define CAN_TTMLM_CSS_POS 6
#define CAN_TTMLM_CSS_MASK (0x3u << CAN_TTMLM_CSS_POS)
#define CAN_TTMLM_CSS(value)                                                   \
	((CAN_TTMLM_CSS_MASK & ((value) << CAN_TTMLM_CSS_POS)))
#define CAN_TTMLM_CCS_NO_SYNC (0x0u << 6)
#define CAN_TTMLM_CCS_SYNC_BASIC (0x1u << 6)
#define CAN_TTMLM_CCS_SYNC_MATRIX (0x2u << 6)
#define CAN_TTMLM_TXEW_POS 8
#define CAN_TTMLM_TXEW_MASK (0xfu << CAN_TTMLM_TXEW_POS)
#define CAN_TTMLM_TXEW(value)                                                  \
	((CAN_TTMLM_TXEW_MASK & ((value) << CAN_TTMLM_TXEW_POS)))
#define CAN_TTMLM_ENTT_POS 16
#define CAN_TTMLM_ENTT_MASK (0xfffu << CAN_TTMLM_ENTT_POS)
#define CAN_TTMLM_ENTT(value)                                                  \
	((CAN_TTMLM_ENTT_MASK & ((value) << CAN_TTMLM_ENTT_POS)))

/* TURCF */
#define CAN_TURCF_NCL_POS 0
#define CAN_TURCF_NCL_MASK (0xffffu << CAN_TURCF_NCL_POS)
#define CAN_TURCF_NCL(value)                                                   \
	((CAN_TURCF_NCL_MASK & ((value) << CAN_TURCF_NCL_POS)))
#define CAN_TURCF_DC_POS 16
#define CAN_TURCF_DC_MASK (0x3fffu << CAN_TURCF_DC_POS)
#define CAN_TURCF_DC(value)                                                    \
	((CAN_TURCF_DC_MASK & ((value) << CAN_TURCF_DC_POS)))
#define CAN_TURCF_ELT (0x1 << 31)

/* TTOCN */
#define CAN_TTOCN_SGT (0x1 << 0)
#define CAN_TTOCN_ECS (0x1 << 1)
#define CAN_TTOCN_SWP(value) (value << 2)
#define CAN_TTOCN_SWS_POS 3
#define CAN_TTOCN_SWS_MASK (0x3u << CAN_TTOCN_SWS_POS)
#define CAN_TTOCN_SWS(value)                                                   \
	((CAN_TTOCN_SWS_MASK & ((value) << CAN_TTOCN_SWS_POS)))
#define CAN_TTOCN_SWS_DISABLED (0x0 << 3)
#define CAN_TTOCN_SWS_COPIED (0x1 << 3)
#define CAN_TTOCN_RTIE (0x1 << 5)
#define CAN_TTOCN_TMC_POS 6
#define CAN_TTOCN_TMC_MASK (0x3u << CAN_TTOCN_TMC_POS)
#define CAN_TTOCN_TMC(value)                                                   \
	((CAN_TTOCN_TMC_MASK & ((value) << CAN_TTOCN_TMC_POS)))
#define CAN_TTOCN_NO_REG_INTR (0x0 << 6)
#define CAN_TTOCN_CYCLE_REG_INTR (0x1 << 6)
#define CAN_TTOCN_LOCAL_REG_INTR (0x2 << 6)
#define CAN_TTOCN_GLOBAL_REG_INTR (0x3 << 6)
#define CAN_TTOCN_TTIE (0x1u << 8)
#define CAN_TTOCN_GCS (0x1u << 9)
#define CAN_TTOCN_FGP (0x1u << 10)
#define CAN_TTOCN_TMG (0x1u << 11)
#define CAN_TTOCN_NIG (0x1u << 12)
#define CAN_TTOCN_ESCN (0x1u << 13)
#define CAN_TTOCN_LCKC (0x1u << 15)

/* TTGTP */
#define CAN_TTGTP_TP_POS 0
#define CAN_TTGTP_TP_MASK (0xffffu << CAN_TTGTP_TP_POS)
#define CAN_TTGTP_TP(value)                                                    \
	((CAN_TTGTP_TP_MASK & ((value) << CAN_TTGTP_TP_POS)))
#define CAN_TTGTP_CTP_POS 0
#define CAN_TTGTP_CTP_MASK (0xffffu << CAN_TTGTP_CTP_POS)
#define CAN_TTGTP_CTP(value)                                                   \
	((CAN_TTGTP_CTP_MASK & ((value) << CAN_TTGTP_CTP_POS)))

/* TTTMK */
#define CAN_TTTMK_TM_POS 0
#define CAN_TTTMK_TM_MASK (0xffffu << CAN_TTTMK_TM_POS)
#define CAN_TTTMK_TM(value)                                                    \
	((CAN_TTTMK_TM_MASK & ((value) << CAN_TTTMK_TM_POS)))
#define CAN_TTTMK_TICC_POS 16
#define CAN_TTTMK_TICC_MASK (0x3fu << CAN_TTTMK_TICC_POS)
#define CAN_TTTMK_TICC(value)                                                  \
	((CAN_TTTMK_TICC_MASK & ((value) << CAN_TTTMK_TICC_POS)))
#define CAN_TTTMK_LCKM (0x1u << 31)

/* TTIR */
#define CAN_TTIR_SBC (0x1u << 0)
#define CAN_TTIR_SMC (0x1u << 1)
#define CAN_TTIR_CSM (0x1u << 2)
#define CAN_TTIR_SOG (0x1u << 3)
#define CAN_TTIR_RTMI (0x1u << 4)
#define CAN_TTIR_TTMI (0x1u << 5)
#define CAN_TTIR_SWE (0x1u << 6)
#define CAN_TTIR_GTW (0x1u << 7)
#define CAN_TTIR_GTD (0x1u << 8)
#define CAN_TTIR_GTE (0x1u << 9)
#define CAN_TTIR_TXU (0x1u << 10)
#define CAN_TTIR_TXO (0x1u << 11)
#define CAN_TTIR_SE1 (0x1u << 12)
#define CAN_TTIR_SE2 (0x1u << 13)
#define CAN_TTIR_ELC (0x1u << 14)
#define CAN_TTIR_IWT (0x1u << 15)
#define CAN_TTIR_WT (0x1u << 16)
#define CAN_TTIR_AW (0x1u << 17)
#define CAN_TTIR_CER (0x1u << 18)

#define CAN_TTIR_ERR                                                           \
	(CAN_TTIR_CER | CAN_TTIR_AW | CAN_TTIR_ELC | CAN_TTIR_SE2 |            \
	 CAN_TTIR_SE1 | CAN_TTIR_TXO | CAN_TTIR_TXU | CAN_TTIR_GTE)
/* TTIE */
#define CAN_TTIE_SBCE (0x1u << 0)
#define CAN_TTIE_SMCE (0x1u << 1)
#define CAN_TTIE_CSME (0x1u << 2)
#define CAN_TTIE_SOGE (0x1u << 3)
#define CAN_TTIE_RTMIE (0x1u << 4)
#define CAN_TTIE_TTMIE (0x1u << 5)
#define CAN_TTIE_SWEE (0x1u << 6)
#define CAN_TTIE_GTWE (0x1u << 7)
#define CAN_TTIE_GTDE (0x1u << 8)
#define CAN_TTIE_GTEE (0x1u << 9)
#define CAN_TTIE_TXUE (0x1u << 10)
#define CAN_TTIE_TXOE (0x1u << 11)
#define CAN_TTIE_SE1E (0x1u << 12)
#define CAN_TTIE_SE2E (0x1u << 13)
#define CAN_TTIE_ELCE (0x1u << 14)
#define CAN_TTIE_IWTE (0x1u << 15)
#define CAN_TTIE_WTE (0x1u << 16)
#define CAN_TTIE_AWE (0x1u << 17)
#define CAN_TTIE_CERE (0x1u << 18)

/* TTOST */
#define CAN_TTOST_EL_POS 0
#define CAN_TTOST_EL_MASK (0x3u << CAN_TTOST_EL_POS)
#define CAN_TTOST_EL(value)                                                    \
	((CAN_TTOST_EL_MASK & ((value) << CAN_TTOST_EL_POS)))
#define CAN_TTOST_EL_NO_ERR (0x0u << 0)
#define CAN_TTOST_EL_WARNING (0x1u << 0)
#define CAN_TTOST_EL_ERROR (0x2u << 0)
#define CAN_TTOST_EL_SEVERE_ERR (0x3u << 0)
#define CAN_TTOST_MS_POS 2
#define CAN_TTOST_MS_MASK (0x3u << CAN_TTOST_MS_POS)
#define CAN_TTOST_MS(value)                                                    \
	((CAN_TTOST_MS_MASK & ((value) << CAN_TTOST_MS_POS)))
#define CAN_TTOST_MS_NO_MASTER (0x0u << 2)
#define CAN_TTOST_MS_TIME_SLAVE (0x1u << 2)
#define CAN_TTOST_MS_BACKUP_TIME_MASTER (0x2u << 2)
#define CAN_TTOST_MS_CURR_TIME_MASTER (0x3u << 2)
#define CAN_TTOST_SYS_POS 4
#define CAN_TTOST_SYS_MASK (0x3u << CAN_TTOST_SYS_POS)
#define CAN_TTOST_SYS(value)                                                   \
	((CAN_TTOST_SYS_MASK & ((value) << CAN_TTOST_SYS_POS)))
#define CAN_TTOST_SYS_OUT_OF_SYNC (0x0u << 2)
#define CAN_TTOST_SYS_SYNC_TTCAN (0x1u << 2)
#define CAN_TTOST_SYS_SCHED_SUSPENDED (0x2u << 2)
#define CAN_TTOST_SYS_SYNC_SCHED (0x3u << 0)
#define CAN_TTOST_QGTP (0x1u << 6)
#define CAN_TTOST_QCS (0x1u << 7)
#define CAN_TTOST_RTO_POS 8
#define CAN_TTOST_RTO_MASK (0xffu << CAN_TTOST_RTO_POS)
#define CAN_TTOST_RTO(value)                                                   \
	((CAN_TTOST_RTO_MASK & ((value) << CAN_TTOST_RTO_POS)))
#define CAN_TTOST_WGTD (0x1u << 22)
#define CAN_TTOST_GFI (0x1u << 23)
#define CAN_TTOST_TMP_POS 24
#define CAN_TTOST_TMP_MASK (0x3u << CAN_TTOST_TMP_POS)
#define CAN_TTOST_TMP(value)                                                   \
	((CAN_TTOST_TMP_MASK & ((value) << CAN_TTOST_TMP_POS)))
#define CAN_TTOST_GSI (0x1u << 27)
#define CAN_TTOST_WFE (0x1u << 28)
#define CAN_TTOST_AWE (0x1u << 29)
#define CAN_TTOST_WECS (0x1u << 30)
#define CAN_TTOST_SPL (0x1u << 31)

/* TURNA */
#define CAN_TURNA_NAV_POS 0
#define CAN_TURNA_NAV_MASK (0x3ffffu << CAN_TURNA_NAV_POS)
#define CAN_TURNA_NAV(value)                                                   \
	((CAN_TURNA_NAV_MASK & ((value) << CAN_TURNA_NAV_POS)))

/* TTLGT */
#define CAN_TTLGT_LT_POS 0
#define CAN_TTLGT_LT_MASK (0xffffu << CAN_TTLGT_LT_POS)
#define CAN_TTLGT_GT_POS 16
#define CAN_TTLGT_GT_MASK (0xffffu << CAN_TTLGT_GT_POS)

/* TTCTC */
#define CAN_TTCTC_CT_POS 0
#define CAN_TTCTC_CT_MASK (0xffffu << CAN_TTCTC_CT_POS)
#define CAN_TTCTC_CC_POS 16
#define CAN_TTCTC_CC_MASK (0x3fu << CAN_TTCTC_CC_POS)

/* TTCPT */
#define CAN_TTCPT_CCV_POS 0
#define CAN_TTCPT_CCV_MASK (0x3fu << CAN_TTCPT_CCV_POS)
#define CAN_TTCPT_SWV_POS 16
#define CAN_TTCPT_SWV_MASK (0xffffu << CAN_TTCPT_SWV_POS)

/* TTCSM */
#define CAN_TTCSM_CSM_POS 0
#define CAN_TTCSM_CSM_MASK (0xffffu << CAN_TTCSM_CSM_POS)
...
#define PARITY_ADDR_STAT_CONFLICT_OCCURRED_MASK (0x1 << 16)

/* parity control register */
/* PAR_CTL_STAT */
#define PARITY_CTL_PAR_ENABLE (0x1 << 0)
#define PARITY_CTL_PAR_INIT_PROGRESS (0x1 << 1)
#define PARITY_CTL_PAR_ERR_OCCURRED (0x1 << 2)
...
#define PARITY_CTL_ERR_INJ_ONETIME_OCCURRED (0x1 << 2)
