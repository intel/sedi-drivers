...
#define CONFIG_INTR_ERROR                                                      \
	(BIT_INTR_RX_OVER | BIT_INTR_RX_UNDER | BIT_INTR_TX_OVER |             \
	 BIT_INTR_TX_ABORT)

#define CONFIG_INTR_SEND                                                       \
	(BIT_INTR_TX_EMPTY | BIT_INTR_STOP_DET | CONFIG_INTR_ERROR)

#define CONFIG_INTR_RECV                                                       \
	(BIT_INTR_TX_EMPTY | BIT_INTR_RX_FULL | BIT_INTR_STOP_DET |            \
	 CONFIG_INTR_ERROR)

#define CONFIG_MASTER_DEFAULT                                                  \
	(BIT_SLAVE_DISABLE | BIT_RESTART_ENABLE | BIT_MODE_MASTER |            \
	 BIT_FIFO_EMPTY_CTRL)
