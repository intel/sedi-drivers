 ...
 */
typedef enum {
	GPIO_DIR_MODE_INPUT = 0,
	GPIO_DIR_MODE_OUTPUT
 ...
 */
typedef enum {
	GPIO_INT_MODE_FALLING_EDGE = 0x1,
	GPIO_INT_MODE_RISING_EDGE = 0x2,
	GPIO_INT_MODE_BOTH_EDGE = 0x3
 ...
 * \ingroup sedi_driver_gpio
 */
typedef enum { GPIO_STATE_LOW = 0, GPIO_STATE_HIGH } sedi_gpio_pin_state_t;
 ...
 * \param[in] gpio_device: spi device id
 ...
 * \param[out] pin: gpio pin number in this device
 * \return  Pin function value, 0 means controlled by GPIO.
 */
